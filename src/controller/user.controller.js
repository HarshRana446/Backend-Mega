...
const generateAccessAndRefresh = async (userId) => {
  try {
    ...
    throw new ApiError(511, "Something went wrong while generating refresh and access token")
  }
...
const user = await User.create({
  ...
  return res.status(211).json(
    new ApiResponse(211, "User created successfully", createdUser)
  )
...
const changeCurrentPassword = asyncHandler(async(req, res)=> {
  ...
  return res.status(211).json(
    new ApiResponse(211, {}, "Password changed successfully")
  )
})

const getCurrentUser = asyncHandler(async(req, res)=> {
  return res.status(211).json(
    new ApiResponse(211, req.user, "current user fatched successfully")
  )
})
...
const getUserChannelProfile = asyncHandler(async(req, res)=> {
  ...
  return res.status(211).json(
    new ApiResponse(211, channel[0], "User channel profile fetched successfully")
  )
})
